...
const newsData = [
  {
    ...
    Tay vợt người Đức đã nâng cao trình độ của mình trong những thời điểm quan trọng, dựa vào cú giao bóng đầu tiên mạnh mẽ của mình và tiến lên để gây áp lực lên Arnaldi, 24 tuổi. Zverev đã ghi được 32 bàn thắng, chuyển đổi 22 trong số những điểm đó.
    “Thời gian nghỉ ở set thứ hai đã giải phóng tôi một chút và cho tôi một chút không gian để thở, ít nhất là trong set đó. Tôi bắt đầu chơi tốt hơn từ đó, tôi nghĩ có lẽ anh ấy chơi tệ hơn một chút từ thời điểm đó trở đi", Zverev, người đã cải thiện thành tích lên 12-3 trong mùa giải và 14-4 tại giải ATP 500 Mexico, nơi anh đã thua ở vòng mở màn năm ngoái trước đồng hương Daniel Altmaier — thất bại duy nhất ở vòng đầu tiên của tay vợt 27 tuổi này kể từ đầu năm 2024, cho biết.
    Tiếp theo đối với Zverev sẽ là Learner Tien, người cực kỳ ổn định. Tay vợt người Mỹ này đã lọt vào vòng chung kết Next Gen ATP Finals năm ngoái do PIF tổ chức. Tien, 19 tuổi, đã đánh bại á quân Acapulco 2022 Cameron Norrie với tỷ số 7-6(5), 6-3 ở vòng đầu tiên.
    
    Trong nửa lượt đấu của Zverev, hạt giống số 4 Holger Rune đã tiến lên với chiến thắng 7-6(4), 6-3 trước Roberto Carballes Baena. Tay vợt 21 tuổi người Đan Mạch đã cân bằng tỷ số trong loạt trận Lexus ATP Head2Head với Carballes Baena là 2-2 và sẽ đối đầu với tay vợt người Mỹ Brandon Nakashima, người đã tiến gần hơn đến chiến thắng thứ 100 ở cấp độ giải đấu bằng cách đánh bại tay vợt người Pháp Benjamin Bonzi với tỷ số 7-6(6), 7-5.`,
  },
  {
    id: 2,
    title:
    ...
    “Thật không thể tin được. Tôi chưa từng làm điều đó trước đây”, Tiafoe nói. “Tôi chưa từng rời khỏi khách sạn ở Acapulco trước đây, vì vậy được ngắm nhìn tất cả các vách đá và mọi thứ, được chứng kiến ​​Acapulco đẹp như thế nào thật tuyệt vời. Tôi nghĩ đó chắc chắn là bức ảnh đẹp nhất mà bạn có thể chụp được. Tôi hy vọng Holger cũng thích nó. Có lẽ đó là một trong những trải nghiệm tuyệt vời nhất của tôi khi chơi quần vợt”.
    `,
  },
  {
    id: 3,
    ...
    Sau thời gian ở Turin, Budkov Kjaer đã tham gia một sự kiện ATP Challenger Tour tại Tây Ban Nha, nơi anh đã đánh bại tay vợt số 114 thế giới Francseco Passaro và cựu ngôi sao Top 10 Pablo Carreno Busta.
    Tiếp nối sự vươn lên của Budkov Kjaer là đồng hương Casper Ruud, tay vợt người Na Uy xếp hạng cao nhất trong lịch sử.`,
  },
  {
    id: 4,
...
renderNews(); // Load trang đầu tiên
